...
public class UserDAO {
    ...
    public void insert(User user) throws SQLException {
        String sql = "INSERT INTO user(name, email, password, address, phone, role_id) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public User checkLogin(String email, String password) {
        String sql = "SELECT u.*, r.role_id, r.role_name FROM user u JOIN role r ON u.role_id = r.role_id WHERE u.email=? AND u.password=? AND u.is_active = 1";
    ...
    public List<User> selectAll() {
        ...
        String sql = "SELECT u.*, r.role_id, r.role_name FROM user u JOIN role r ON u.role_id = r.role_id";
